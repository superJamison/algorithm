...
//            System.out.print(node.element + ", ");
    ...
    public Object left(Object node) {
        return ((BinarySearchTree.Node<T>) node).left;
    }

    @Override
    public Object right(Object node) {
        return ((BinarySearchTree.Node<T>) node).right;
    }

    @Override
    public Object string(Object node) {
        BinarySearchTree.Node<T> myNode = (BinarySearchTree.Node<T>) node;
        String parentStr = "null";
        if (myNode.parent != null) {
            parentStr = myNode.parent.element.toString();
        }
        return ((BinarySearchTree.Node<T>) node).element + "_p(" + parentStr + ")";
    }
}
